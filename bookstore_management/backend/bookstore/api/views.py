...
class BookListCreateAPIView(generics.ListCreateAPIView): #handle get, post request
    queryset = BookStoreModel.objects.all()
    serializer_class = BookStoreSerializer


class BookRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView): # handle update, delete & acces single element
    queryset = BookStoreModel.objects.all()
    serializer_class = BookStoreSerializer"""

#method -3 : shortcut/model views set
